...
import com.treasurehunt.retail118.fragments.AlertDialogFragment;
...
public abstract class RetriveData extends Fragment {
    ...
    protected abstract ArrayList<Product> getProds();

    protected abstract void updateDisplay();

    protected abstract String getProductsUrl();
  ...
  /*  public void updateDisplay(){
        ...
        // FragmentHighlightAdapter gridAdapter=new FragmentHighlightAdapter(listener,mProducts);
