 ...
 */
public class GridAdapter extends RecyclerAdapters{
   ...
   // private final MenuFragments.OnMenuSelectedInterface mListener;
    ...
    public GridAdapter(MyInterface listener,ArrayList<Product> products) {
        mListener=listener;
        mProducts=products;
    }
    ...
    protected int getProductNameView() {
        return R.id.menuItemText;
    }

    @Override
    protected int getImageIdView() {
        return R.id.menuItem_image;
    }
